...
const MessageSection = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to(firstMsgSplit.words, {
        color: "#faeade",
        ease: "power1.in",
        stagger: 1, //each word will animate 1 sec after the previous one.
        scrollTrigger: {
            trigger: ".message-content",
            start: "top center",
            end: "30% center", //30% from top of viewport
            scrub: true,
        },
    });
    ...
    paragraphTl.from(paragraphSplit.words, {
        yPercent: 300, //each word starts 300 below its final position
        rotate: 3, //rotate at a slight angle of 3 degrees
        ease: "power1.inOut",
        duration: 1,
        stagger: 0.01,
    });
